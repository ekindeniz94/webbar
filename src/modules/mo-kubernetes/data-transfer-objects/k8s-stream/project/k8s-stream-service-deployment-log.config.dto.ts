 ...
 * Deprecated
 */
export class K8sStreamServiceDeploymentLogConfigDto extends K8sStreamBaseNamespaceContainerConfigDto {
  @Transform(() => K8sStreamRequestTypeEnum.SERVICE__DEPLOYMENT_LOG)
  @Expose()
  type: K8sStreamRequestTypeEnum.SERVICE__DEPLOYMENT_LOG;
