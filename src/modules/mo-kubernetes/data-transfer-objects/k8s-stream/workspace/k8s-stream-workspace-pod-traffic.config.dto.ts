...
export class K8sStreamWorkspacePodTrafficConfigDto extends K8sStreamBaseConfigDto {
  @Transform(() => K8sStreamRequestTypeEnum.WORKSPACE__LIVE_STREAM_POD_TRAFFIC)
  @IsEnum(K8sStreamRequestTypeEnum)
  @Expose()
  type: K8sStreamRequestTypeEnum.WORKSPACE__LIVE_STREAM_POD_TRAFFIC;
