...
export class K8sStreamWorkspaceOperatorLogConfigDto extends K8sStreamBaseNamespaceContainerConfigDto {
  @Transform(() => K8sStreamCmdEnum.LOG)
  @Expose()
  cmd: K8sStreamCmdEnum.LOG;

  @Transform(() => K8sStreamRequestTypeEnum.WORKSPACE__OPERATOR_LOG)
  @Expose()
  type: K8sStreamRequestTypeEnum.WORKSPACE__OPERATOR_LOG;
