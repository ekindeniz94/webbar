...
export class K8sStreamWorkspacePodMemoryConfigDto extends K8sStreamBaseConfigDto {
  @Transform(() => K8sStreamRequestTypeEnum.WORKSPACE__LIVE_STREAM_POD_MEMORY)
  @IsEnum(K8sStreamRequestTypeEnum)
  @Expose()
  type: K8sStreamRequestTypeEnum.WORKSPACE__LIVE_STREAM_POD_MEMORY;
