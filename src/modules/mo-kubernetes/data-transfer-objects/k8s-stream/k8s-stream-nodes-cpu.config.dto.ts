...
export class K8sStreamNodesCpuConfigDto extends K8sStreamBaseConfigDto {
  @Transform(() => K8sStreamRequestTypeEnum.CLUSTER__NODE_STREAM_NODES_CPU)
  @IsEnum(K8sStreamRequestTypeEnum)
  @Expose()
  type: K8sStreamRequestTypeEnum.CLUSTER__NODE_STREAM_NODES_CPU;
